...
const Settings = () => {
  ...
  return (
    <View style={styles.container}>
      <ButtonKitten
          onPress={
            () => axios.get(`http://192.168.1.112:9464/workshop/mainScreen/close_app`)
            .then((response) => {
        ...
        >
          ...
          <ButtonKitten
          onPress={
            () => axios.get(`http://192.168.1.112:9464/workshop/mainScreen/clickedOnSleepButton`)
            .then((response) => {
        ...
        <ButtonKitten
          onPress={
            () => axios.get(`http://192.168.1.112:9464/workshop/mainScreen/SimulateInvalidElectricityConsumption`)
            .then((response) => {
